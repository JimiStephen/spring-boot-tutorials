...
package com.jimi.spring.boot.web.freemarker;
...
/**
 * 如果测试的类没有在同一个包目录下面，可以使用下面的指定 含有@SpringBootApplication的classss可以进行测试。
 */
//@ContextConfiguration(classes = com.jimi.spring.boot.web.freemarker.SampleWebFreeMarkerApplication.class)
public class SampleWebFreeMarkerApplicationTests {
	...
	public void testFreeMarkerTemplate() {
		...
		assertThat(entity.getBody()).contains("Hello Phil");
	}
